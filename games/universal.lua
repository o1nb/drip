...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('Drip X/assets/new/blur.png')
...
local hash = loadstring(downloadFile('Drip X/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('Drip X/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('Drip X/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('Drip X/profiles/whitelist.json') and readfile('Drip X/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('Drip X/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('Drip X/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('Drip X/assets/new/radaricon.png'),
